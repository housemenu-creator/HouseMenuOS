/**
 * Root-level type declarations for firebase/database.
 *
 * Firebase v12.13.0 ships broken types: @firebase/database 1.1.3 references
 * dist/public.d.ts which does not exist. This declaration fills the gap
 * for all apps in the monorepo.
 *
 * Remove when firebase publishes a fix (upgrade to >12.13.0 and verify).
 */
