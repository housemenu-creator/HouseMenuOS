...
export const menuTools: MCPTool[] = [
  {
    name: "ver_menu",
    description: "Obtiene el menú completo con todos los productos disponibles del restaurante, agrupados por categoría",
    parameters: {},
    async execute(_args, branchId) {
      ...
      let msg = "📋 *MENÚ*\n\n";
        ...
        return { success: true, data: catalog, message: msg.trim() };
      } catch (e: any) {
