...
export default function NanoBananaGenerator() {
  ...
  return (
    <div className="p-6 glass rounded-[2rem] border border-hub-border w-full shadow-2xl relative overflow-hidden group">
      {/* Background Accent */}
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold text-hub-muted uppercase tracking-[0.2em]">IA Visual Studio</p>
        </div>
      </div>
      ...
      <div className="space-y-5">
        {/* Style Selector */}
        <div>
          <label className="text-[10px] font-black text-hub-muted uppercase tracking-widest mb-3 block opacity-60">
            Estilo Visual
          </label>
              ...
              <button
                ...
                className={`px-3 py-2.5 rounded-xl text-[11px] font-bold transition-all border flex items-center justify-between ${
                  selectedStyle.id === style.id
                    ...
                    : "bg-hub-bg/50 text-hub-muted border-hub-border hover:border-orange-500/30"
                }`}
              >
                {style.label}
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-hub-bg/40 border border-hub-border rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/30 min-h-[120px] resize-none font-medium placeholder:opacity-30 transition-all"
          />
        </div>
        ...
        <AnimatePresence>
          ...
          {imageUrl && (
            <motion.div
              ...
              className="relative aspect-square rounded-[2rem] overflow-hidden border border-hub-border group mt-4 shadow-2xl"
            >
