...
export const ROLE_REGISTRY = {
  ...
  admin: {
    ...
    adminTabs: ['dashboard', 'orders', 'menu', 'inventory', 'caja', 'finanzas', 'sucursales', 'delivery', 'fiscal', 'users', 'marketing', 'analytics', 'customers', 'logistics', 'employees', 'settings', 'reservations', 'branding', 'pipeline', 'bot'],
  },
  cajero: {
    name: 'Cajero',
    key: 'cajero',
  ...
  jefe_de_cocina: {
    ...
    loginScreen: { title: 'House KDS', subtitle: 'Jefe de Cocina · House', icon: ChefHat },
    defaultUser: { email: 'jefe_cocina@house.local', name: 'Jefe de Cocina', pin: '7777' },
    adminTabs: ['dashboard', 'orders', 'menu', 'inventory', 'analytics', 'logistics', 'employees'],
  },
  cocinero_principal: {
    name: 'Cocinero Principal',
    key: 'cocinero_principal',
    permissions: {
      'orders:read': true,
      'orders:create': true,
      'orders:update_status': true,
    ...
    loginScreen: { title: 'House KDS', subtitle: 'Cocinero Principal · House', icon: ChefHat },
    defaultUser: { email: 'cocinero_principal@house.local', name: 'Cocinero Principal', pin: '8888' },
    adminTabs: ['dashboard', 'orders', 'menu', 'inventory'],
  },
  dispatch: {
    name: 'Reparto',
    key: 'dispatch',
